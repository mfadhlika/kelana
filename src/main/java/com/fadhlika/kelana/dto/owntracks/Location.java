...
public record Location(
    ...
    public com.fadhlika.kelana.model.Location toLocation(int userId, String deviceId) throws JsonProcessingException {
        com.fadhlika.kelana.model.Location l = new com.fadhlika.kelana.model.Location(this.lat(), this.lon());
