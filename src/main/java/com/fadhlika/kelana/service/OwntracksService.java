...
public class OwntracksService {
    ...
    public Optional<?> handleMessage(User user, String deviceId, com.fadhlika.kelana.dto.owntracks.Message message)
        ...
        switch (message) {
            case com.fadhlika.kelana.dto.owntracks.Location location:
                return this.handleMessageLocation(user, deviceId, location);
            case com.fadhlika.kelana.dto.owntracks.Request request:
    ...
    public Optional<List<com.fadhlika.kelana.dto.owntracks.Message>> handleMessageLocation(User user, String deviceId,
            com.fadhlika.kelana.dto.owntracks.Location location) throws JsonProcessingException {
    ...
    public Optional<com.fadhlika.kelana.dto.owntracks.Message> handleMessageRequest(User user, String deviceId,
            com.fadhlika.kelana.dto.owntracks.Request request) {
        switch (request.request()) {
            ...
            case "tours":
                ...
                List<com.fadhlika.kelana.dto.owntracks.Tour> tours = this.tripService
                        .getTrips(user.getId(), Optional.of(true))
                        .stream()
                        .map((t) -> new com.fadhlika.kelana.dto.owntracks.Tour(t.title(),
                                t.startAt(),
                                t.endAt(), t.uuid(),
